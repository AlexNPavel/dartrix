  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    _FutureListener: {
      ...
      handleError$1: function(asyncError) {
        ...
        t3 = this.result;
        if (t2)
          return t3._zone.runBinary$3(t1, asyncError.error, asyncError.stackTrace);
        else
          return t3._zone.runUnary$2(t1, asyncError.error);
      }
    },
    _Future: {
    ...
    _HashMap: {
      ...
      _get$1: function(key) {
        ...
        if (rest == null)
          return;
        t1 = rest[H.objectHashCode(key) & 0x3ffffff];
    ...
    ListQueue: {
      ...
      addAll$1: function(_, elements) {
        ...
        if (!!t1.$isList) {
          ...
          t3 = t2.length;
          if (t1 >= t3) {
            t2 = new Array(P.ListQueue__nextPowerOf2(t1 + (t1 >>> 1)));
    ...
    SelectElement: {
      "^": "HtmlElement;disabled},length%,name%",
      "%": "HTMLSelectElement"
    },
    ...
    MainApp: {
      ...
      ready$0: [function(receiver) {
        ...
        for (t1 = t1.matrix, i = 0; i < t1.length; ++i) {
          ...
          for (h = 0; h < J.get$length$asx(t1[i]); ++h)
            J.insert$2$ax(J.$index$asx(receiver.$$MainApp_mainA, i), h, J.$index$asx(t1[i], h));
        }
      ...
      updateinputs$2: [function(receiver, $event, _) {
        ...
        t2 = receiver.$$MainApp_buttons;
        if (J.$eq$(receiver.$$MainApp_complete.$index(0, H.stringTypeCast(t1.get$detail($event))), true))
      ...
      createREF$2: [function(receiver, $event, _) {
        ...
        for (i = 0; i < J.get$length$asx(receiver.$$MainApp_inputs.$index(0, "ref")); ++i) {
          J.insert$2$ax(receiver.$$MainApp_ref, i, []);
          for (h = 0; h < J.get$length$asx(J.$index$asx(receiver.$$MainApp_inputs.$index(0, "ref"), i)); ++h)
            J.insert$2$ax(J.$index$asx(receiver.$$MainApp_ref, i), h, J.$index$asx(J.$index$asx(receiver.$$MainApp_inputs.$index(0, "ref"), i), h));
        }
      ...
      createRREF$2: [function(receiver, $event, _) {
        ...
        for (i = 0; i < J.get$length$asx(receiver.$$MainApp_inputs.$index(0, "rref")); ++i) {
          J.insert$2$ax(receiver.$$MainApp_rref, i, []);
          for (h = 0; h < J.get$length$asx(J.$index$asx(receiver.$$MainApp_inputs.$index(0, "rref"), i)); ++h)
            J.insert$2$ax(J.$index$asx(receiver.$$MainApp_rref, i), h, J.$index$asx(J.$index$asx(receiver.$$MainApp_inputs.$index(0, "rref"), i), h));
        }
    ...
    MatrixElement: {
      ...
      ready$0: [function(receiver) {
        ...
        W._ElementCssClassSet__add(t1, "matrix");
        for (i = 0; i < 3; ++i)
          receiver.$$MatrixElement_table.insertRow(-1);
        for (i = 0; i < 3; ++i)
          for (h = 0; h < 3; ++h) {
            J.addCell$0$x(H.setRuntimeTypeInfo(new W._WrappedList(receiver.$$MatrixElement_table.rows), [W.TableRowElement])._list[i]);
            t1 = W._ElementFactoryProvider_createElement_tag("paper-input", null);
            t2 = J.getInterceptor$x(t1);
            t2.set$value(t1, H.S(receiver.$$MatrixElement_name));
            t2.set$readonly(t1, true);
            J.get$cells$x(H.setRuntimeTypeInfo(new W._WrappedList(receiver.$$MatrixElement_table.rows), [W.TableRowElement])._list[i])._list[h].appendChild(t1);
          }
        J.append$1$x(this.get$$$(receiver).$index(0, "matrix"), receiver.$$MatrixElement_table);
      }, "call$0", "get$ready", 0, 0, 2],
      updateMatrix$2: [function(receiver, $event, _) {
        var i, h;
        if (!J.$eq$(J.get$detail$x($event), receiver.$$MatrixElement_name))
          return;
        for (i = 0; i < J.get$length$asx(receiver.$$MatrixElement_data); ++i)
          for (h = 0; h < J.get$length$asx(J.$index$asx(receiver.$$MatrixElement_data, i)); ++h) {
            J.set$value$x(H.interceptedTypeCast(J.get$cells$x(H.setRuntimeTypeInfo(new W._WrappedList(receiver.$$MatrixElement_table.rows), [W.TableRowElement])._list[i])._list[h].firstChild, "$isPaperInput"), H.S(J.$index$asx(J.$index$asx(receiver.$$MatrixElement_data, i), h)));
    ...
    MatrixInputElement: {
      ...
      ready$0: [function(receiver) {
        var t1, i, h, t2, t3, t4, t5;
        receiver.$$MatrixInputElement_inputs.$indexSet(0, receiver.$$MatrixInputElement_name, []);
        J.set$length$asx(receiver.$$MatrixInputElement_inputs.$index(0, receiver.$$MatrixInputElement_name), 3);
        t1 = document;
        t1 = t1.createElement("table");
        $.table = t1;
        W._ElementCssClassSet__add(t1, "matrix");
        for (i = 0; i < 3; ++i) {
          $.table.insertRow(-1);
          J.$indexSet$ax(receiver.$$MatrixInputElement_inputs.$index(0, receiver.$$MatrixInputElement_name), i, []);
          J.set$length$asx(J.$index$asx(receiver.$$MatrixInputElement_inputs.$index(0, receiver.$$MatrixInputElement_name), i), 3);
        }
        for (i = 0; i < 3; ++i)
          for (h = 0; h < 3; ++h) {
            J.addCell$0$x(H.setRuntimeTypeInfo(new W._WrappedList($.table.rows), [W.TableRowElement])._list[i]);
            t1 = W._ElementFactoryProvider_createElement_tag("paper-input", null);
            t1.toString;
            t2 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, "input", false), [H.getTypeArgumentByIndex(C.EventStreamProvider_input, 0)]);
            t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._html$_target, t2._eventType, W._wrapZone(new D.MatrixInputElement_ready_closure(receiver, i, h)), false), [H.getTypeArgumentByIndex(t2, 0)]);
            t3 = t2._html$_onData;
            t4 = t3 != null;
            if (t4 && t2._pauseCount <= 0) {
              t5 = t2._html$_target;
              t5.toString;
              if (t4)
                J._addEventListener$3$x(t5, t2._eventType, t3, false);
            }
            J.get$cells$x(H.setRuntimeTypeInfo(new W._WrappedList($.table.rows), [W.TableRowElement])._list[i])._list[h].appendChild(t1);
          }
        J.append$1$x(this.get$$$(receiver).$index(0, "matrix"), $.table);
      }, "call$0", "get$ready", 0, 0, 2],
      updateMVal$3: function(receiver, e, row, col) {
        var inputS, input, exception, i, h;
        inputS = J.trim$0$s(H.interceptedTypeCast(J.get$target$x(e), "$isIronInput").value);
        if (J.get$length$asx(inputS) === 0) {
          J.$indexSet$ax(J.$index$asx(receiver.$$MatrixInputElement_inputs.$index(0, receiver.$$MatrixInputElement_name), row), col, null);
          receiver.$$MatrixInputElement_complete.$indexSet(0, receiver.$$MatrixInputElement_name, false);
        ...
        if (J.split$1$s(inputS, "/").length === 1)
          ...
          try {
            input = H.Primitives_parseDouble(J.split$1$s(inputS, "/")[0], null) / H.Primitives_parseDouble(J.split$1$s(inputS, "/")[1], null);
          } catch (exception) {
            H.unwrapException(exception);
            J.$indexSet$ax(J.$index$asx(receiver.$$MatrixInputElement_inputs.$index(0, receiver.$$MatrixInputElement_name), row), col, null);
            receiver.$$MatrixInputElement_complete.$indexSet(0, receiver.$$MatrixInputElement_name, false);
        ...
        J.$indexSet$ax(J.$index$asx(receiver.$$MatrixInputElement_inputs.$index(0, receiver.$$MatrixInputElement_name), row), col, input);
        for (i = 0; i < J.get$length$asx(receiver.$$MatrixInputElement_inputs.$index(0, receiver.$$MatrixInputElement_name)); ++i)
          for (h = 0; h < J.get$length$asx(J.$index$asx(receiver.$$MatrixInputElement_inputs.$index(0, receiver.$$MatrixInputElement_name), i)); ++h)
            if (J.$index$asx(J.$index$asx(receiver.$$MatrixInputElement_inputs.$index(0, receiver.$$MatrixInputElement_name), i), h) == null)
              return;
        receiver.$$MatrixInputElement_complete.$indexSet(0, receiver.$$MatrixInputElement_name, true);
        this.fire$2$detail(receiver, "iron-signal", P.LinkedHashMap__makeLiteral(["name", "minputchange", "data", receiver.$$MatrixInputElement_name]));
      },
      static: {
    ...
    Matrix: {
      ...
      convertREF$0: function() {
        var t1, i, h, t2, t3, focusRow, focusCol, scanRow, temp, t4, t5, i0;
        J.clear$0$ax(this.ref);
        t1 = this.matrix;
        J.set$length$asx(this.ref, t1.length);
        for (i = 0; i < t1.length; ++i) {
          J.$indexSet$ax(this.ref, i, []);
          J.set$length$asx(J.$index$asx(this.ref, i), J.get$length$asx(t1[i]));
          for (h = 0; h < J.get$length$asx(t1[i]); ++h)
            J.$indexSet$ax(J.$index$asx(this.ref, i), h, J.$index$asx(t1[i], h));
        }
        $top$0:
          for (t1 = this.rowSize, t2 = t1 - 1, t3 = this.colSize, focusRow = 0, focusCol = 0; focusRow < t1; focusRow = i) {
            ...
            for (i = focusRow + 1, i0 = i; i0 < J.get$length$asx(this.ref); ++i0)
      ...
      addRow$3: function(_, srcRow, destRow, scale) {
        var t1, t2, i;
        for (t1 = J.getInterceptor$asx(srcRow), t2 = J.getInterceptor$asx(destRow), i = 0; i < t1.get$length(srcRow); ++i) {
      ...
      scaleRow$2: function(row, scale) {
        ...
        if (scale === 0)
          return;
        for (t1 = J.getInterceptor$asx(row), i = 0; i < t1.get$length(row); ++i) {
      ...
      convertRREF$0: function() {
        var i, h, j, j0;
        if (J.get$length$asx(this.ref) !== this.matrix.length)
          this.convertREF$0();
        J.clear$0$ax(this.rref);
        J.set$length$asx(this.rref, J.get$length$asx(this.ref));
        for (i = 0; i < J.get$length$asx(this.ref); ++i) {
          J.$indexSet$ax(this.rref, i, []);
          J.set$length$asx(J.$index$asx(this.rref, i), J.get$length$asx(J.$index$asx(this.ref, i)));
          for (h = 0; h < J.get$length$asx(J.$index$asx(this.ref, i)); ++h)
            J.$indexSet$ax(J.$index$asx(this.rref, i), h, J.$index$asx(J.$index$asx(this.ref, i), h));
        }
        for (i = J.get$length$asx(this.rref) - 1; i >= 0; i = j) {
          h = 0;
          while (true) {
            if (!(h < J.get$length$asx(this.rref) - 1 && J.$eq$(J.$index$asx(J.$index$asx(this.rref, i), h), 0)))
              break;
            ++h;
          }
          this.scaleRow$2(J.$index$asx(this.rref, i), J.$index$asx(J.$index$asx(this.rref, i), h));
          for (j = i - 1, j0 = j; j0 >= 0; --j0)
            if (!J.$eq$(J.$index$asx(J.$index$asx(this.rref, i), h), 0))
              this.addRow$3(0, J.$index$asx(this.rref, i), J.$index$asx(this.rref, j0), J.$div$n(J.$negate$n(J.$index$asx(J.$index$asx(this.rref, j0), h)), J.$index$asx(J.$index$asx(this.rref, i), h)));
        }
      },
      ...
      static: {
        ...
        Matrix_equals: function(correct, check) {
          var t1, t2, t3, t4, i, h, line;
          t1 = J.getInterceptor$asx(correct);
          t2 = J.getInterceptor$asx(check);
          if (t1.get$length(correct) === t2.get$length(check)) {
            t3 = J.get$length$asx(t1.$index(correct, 0));
            t4 = J.get$length$asx(t2.$index(check, 0));
          ...
          for (i = 0; i < t1.get$length(correct); ++i)
            for (h = 0; h < J.get$length$asx(t1.$index(correct, i)); ++h) {
    ...
    addDeclarationToPrototype: function($name, type, declaration, $prototype) {
      ...
      if (T.isProperty(declaration)) {
        ...
        if (!!t1.$isMethodMirror)
          $prototype.$indexSet(0, $name, $.$get$_polymerDart1().callMethod$2("invokeDartFactory", [new T.addDeclarationToPrototype_closure1($name, type, declaration)]));
        else
    ...
    declarationsFor_closure: {
      ...
      call$2: function($name, declaration) {
        ...
        if (t1.containsKey$1($name))
          return;
        if (!this.where.call$2($name, declaration))
          return;
    ...
    _setupRegistrationMethods: function(type, $prototype) {
      ...
      for (_i = 0; _i < 2; ++_i) {
        ...
        if (method == null || !J.getInterceptor(method).$isMethodMirror)
          continue;
        $prototype.$indexSet(0, $name, $.$get$_polymerDart0().callMethod$2("invokeDartFactory", [new U._setupRegistrationMethods_closure(typeMirror, $name)]));
      }
    },
    _getPropertyInfoForType: function(type, declaration) {
      ...
      property = P.LinkedHashMap__makeLiteral(["defined", true, "notify", false, "observer", annotation.observer, "reflectToAttribute", false, "computed", annotation.computed, "value", $.$get$_polymerDart0().callMethod$2("invokeDartFactory", [new U._getPropertyInfoForType_closure0(declaration)])]);
      if (isFinal)
    ...
    _buildBehaviorsList: function(type) {
      var t1, allBehaviors, behaviorStack, t2, behavior, t3, $interface;
      ...
      t1 = [$.$get$_polymerDart0().$index(0, "InteropBehavior")];
    ...
    _buildObserversObject_closure: {
      ...
      call$2: function($name, declaration) {
        ...
        this.observers.push(H.S($name) + "(" + H.S(C.JSNull_methods.get$properties(observe)) + ")");
      }
    },
      ...
      call$2: function($name, declaration) {
        if (C.JSArray_methods.contains$1(C.List_AKW, $name))
          if (!declaration.get$isStatic() && this.isBehavior)
            throw H.wrapException("Lifecycle methods on behaviors must be static methods, found `" + H.S($name) + "` on `" + J.toString$0$(this.type) + "`. The first argument to these methods is theinstance.");
          else if (declaration.get$isStatic() && !this.isBehavior)
            throw H.wrapException("Lifecycle methods on elements must not be static methods, found `" + H.S($name) + "` on class `" + J.toString$0$(this.type) + "`.");
        this.$prototype.$indexSet(0, $name, $.$get$_polymerDart0().callMethod$2("invokeDartFactory", [new U._setupLifecycleMethods__closure(this.type, $name, declaration)]));
      }
    },
    ...
    _buildBehaviorsList_closure: {
      ...
      call$1: [function(behavior) {
        ...
        if (!behavior.get$hasReflectedType())
          behavior.get$hasDynamicReflectedType();
        return meta.getBehavior$1(behavior.get$hasReflectedType() ? behavior.get$reflectedType() : behavior.get$dynamicReflectedType());
    ...
    IronControlState: {
      ...
      set$disabled: function(receiver, value) {
        this.get$jsElement(receiver).$indexSet(0, "disabled", value);
      }
    }
    ...
    IronFormElementBehavior: {
      ...
      set$name: function(receiver, value) {
        this.get$jsElement(receiver).$indexSet(0, "name", value);
      }
    }
    ...
    PaperInputBehavior: {
      ...
      set$readonly: function(receiver, value) {
        this.get$jsElement(receiver).$indexSet(0, "readonly", true);
      },
      set$value: function(receiver, value) {
        var t1 = this.get$jsElement(receiver);
        t1.$indexSet(0, "value", value);
      }
    }
    ...
    convertToDart: [function(jsValue) {
      ...
      if (!!t1.$isJsArray) {
        ...
        t3 = P.List_List$from(H.setRuntimeTypeInfo(new H.MappedListIterable([jsValue, dartList], P.js___convertToJS$closure()), [null, null]), true, null);
        ...
        if (t2.$eq($constructor, $.$get$_Date())) {
          ...
          if (t2.$eq($constructor, t3) && J.$eq$(t1.$index(jsValue, "__proto__"), $.$get$_ObjectPrototype())) {
            ...
            t1 = $.$get$_setDartInstance()._jsObject;
            t2 = P._convertToJS(null);
            t3 = P.List_List$from(H.setRuntimeTypeInfo(new H.MappedListIterable([jsValue, dartMap], P.js___convertToJS$closure()), [null, null]), true, null);
            P._convertToDart(t1.apply(t2, t3));
            return dartMap;
          }
        }
    ...
    CustomEventWrapper: {
      ...
      get$detail: function(_) {
        var t1, value;
        t1 = this.original;
        value = P.JsObject_JsObject$fromBrowserObject(t1).$index(0, "detail");
    ...
    PolymerBase: {
      ...
      get$$$: function(receiver) {
        return this.get$jsElement(receiver).$index(0, "$");
      },
    ...
    _InstanceMirrorImpl: {
      ...
      get$hashCode: function(_) {
        return (H.Primitives_objectHashCode(this._reflector) ^ J.get$hashCode$(this.reflectee)) >>> 0;
      },
    ...
    ClassMirrorBase: {
      "^": "_DataCaching;_reflector<,simpleName<,qualifiedName<",
      get$superinterfaces: function() {
        var t1 = this._superinterfaceIndices;
        if (t1.length === 1 && t1[0] === -1)
      ...
      get$staticMembers: function() {
        ...
        if (t1 == null) {
          ...
          for (t1 = this._staticMemberIndices, t2 = this._reflector, _i = 0; false; ++_i) {
            ...
            declarationMirror = t3.memberMirrors[staticMemberIndex];
            result.$indexSet(0, declarationMirror.get$simpleName(), declarationMirror);
          }
          t1 = H.setRuntimeTypeInfo(new P.UnmodifiableMapView(result), [P.String, O.MethodMirror]);
    ...
    ClassMirrorBase_superinterfaces_closure: {
      ...
      call$1: [function(i) {
        ...
        return this.$this.get$_data().typeMirrors[i];
      }, null, null, 2, 0, null, 17, "call"]
    },
    ...
    InstantiatedGenericClassMirrorImpl: {
      ...
      get$hashCode: function(_) {
        return (H.Primitives_objectHashCode(this.get$originalDeclaration()) ^ J.get$hashCode$(this._reflectedType)) >>> 0;
      },
      toString$0: function(_) {
    ...
    MethodMirrorImpl: {
      ...
      get$returnType: function() {
        ...
        if ((t2 & 131072) !== 0)
          return (t2 & 4194304) !== 0 ? U._createInstantiatedGenericClass(this.get$_data().typeMirrors[t1], null) : this.get$_data().typeMirrors[t1];
      ...
      _isArgumentListShapeAppropriate$2: function(numberOfPositionalArguments, namedArgumentNames) {
        ...
        if (this._numberOfOptionalPositionalParameters == null)
          this._setupParameterListInfo$0();
        if (numberOfPositionalArguments >= t1 - this._numberOfOptionalPositionalParameters) {
          if (this._numberOfPositionalParameters == null)
            this._setupParameterListInfo$0();
          t1 = numberOfPositionalArguments > this._numberOfPositionalParameters;
        } else
          t1 = true;
        if (t1)
          return false;
    ...
    MethodMirrorImpl_parameters_closure: {
      ...
      call$1: [function(parameterIndex) {
        return this.$this.get$_data().parameterMirrors[parameterIndex];
    ...
    ImplicitGetterMirrorImpl: {
      ...
      get$qualifiedName: function() {
        var t1 = this.get$_data().memberMirrors[this._variableMirrorIndex];
        return t1.get$owner().get$qualifiedName() + "." + t1._reflectable_transformer_based$_name;
      },
      get$simpleName: function() {
        return this.get$_data().memberMirrors[this._variableMirrorIndex]._reflectable_transformer_based$_name;
      },
      toString$0: function(_) {
        var t1 = this.get$_data().memberMirrors[this._variableMirrorIndex];
        return "ImplicitGetterMirrorImpl(" + (t1.get$owner().get$qualifiedName() + "." + t1._reflectable_transformer_based$_name) + ")";
      },
      static: {
    ...
    ImplicitSetterMirrorImpl: {
      ...
      toString$0: function(_) {
        var t1 = this.get$_data().memberMirrors[this._variableMirrorIndex];
        return "ImplicitSetterMirrorImpl(" + (t1.get$owner().get$qualifiedName() + "." + t1._reflectable_transformer_based$_name + "=") + ")";
      },
      static: {
    ...
    VariableMirrorBase: {
      ...
      get$type: function(_) {
        ...
        if ((t2 & 32768) !== 0) {
          if ((t2 & 2097152) !== 0) {
            t1 = this.get$_data().typeMirrors[t1];
      ...
      get$reflectedType: function() {
        ...
        var t1 = this._reflectedTypeIndex;
        if (t1 === -1)
        ...
        return this.get$_data().types[t1];
      },
      get$hashCode: function(_) {
        var t1, t2;
    ...
    ParameterMirrorImpl: {
      ...
      $eq: function(_, other) {
        if (other == null)
          return false;
        return other instanceof U.ParameterMirrorImpl && other._reflectable_transformer_based$_name === this._reflectable_transformer_based$_name && other.get$_data().memberMirrors[other._ownerIndex] === this.get$_data().memberMirrors[this._ownerIndex];
      },
      $isVariableMirror: 1,
      static: {
